...
A screenshot prevention modifier for SwiftUI, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/ScreenshotPreventionSwiftUI.git
   ```
### Usage

1. How to use the screenshot prevention modifier on any view
